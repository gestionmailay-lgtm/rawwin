...
async function run() {
  try {
    ...
    // Available datapoints requires startTime and endTime query parameters
    ...
    console.log("Fetching available datapoints from:", url);
    ...
    console.log("SUCCESS! Available datapoints count:", json.length);
    console.log("Datapoints list:\n", JSON.stringify(json, null, 2));
